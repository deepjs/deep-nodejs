...
deep.nodejs.files.Object = deep.compose.Classes(deep.store.Object,
{
...
deep.nodejs.files.Object.create = function(protocol, filePath, schema, options){
	options = options || {};
	this.filePath = filePath;
	var store = new deep.nodejs.files.Object(protocol, filePath, schema, options);
	return store;
};

deep.sheet(deep.nodejs.files.Object.prototype, {
...
//deep.coreUnits.push("req::deep-node-fs/units/generic");

module.exports = deep.nodejs.files.Object;
